...
* Access to the report continues to rely on Moodle capabilities. Teachers and managers must have the capability `block/report_customcajasan:viewreport` within the relevant course context.
