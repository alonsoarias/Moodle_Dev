...
class cleanup_expired_transactions extends scheduled_task {
    ...
    public function get_name(): string {
        return get_string('task_cleanup_expired', 'paygw_wompi');
    }
    ...
    public function execute(): void {
        ...
        foreach ($transactions as $transaction) {
            try {
                ...
                mtrace("  Transaction {$transaction->transactionid}: Marked as EXPIRED");
                $cleaned++;
    ...
    private function send_expiry_notification(object $transaction): void {
        ...
        $subject = get_string('payment_expired_subject', 'paygw_wompi');
        $message = get_string('payment_expired_message', 'paygw_wompi', [
