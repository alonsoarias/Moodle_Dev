...
// Corregimos la ruta para que sean 3 niveles arriba (theme/nexo/cli -> MOODLE_ROOT)
...
Examples:
\$ php theme/nexo/cli/migrate_settings.php --mode=check
\$ php theme/nexo/cli/migrate_settings.php --mode=migrate
";
    echo $help;
    exit(0);
}
...
echo "Checking theme_nexo settings...\n";
foreach ($oldtonew as $old => $new) {
    $value = get_config('theme_nexo', $old);
    $newvalue = get_config('theme_nexo', $new);
