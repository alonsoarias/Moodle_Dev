<?php
/**
 * Login page layout for theme_nexo
 *
 * @package   theme_nexo
...
$templatecontext = [
    ...
    'my_credit' => get_string('credit', 'theme_nexo'),
...
if (empty($templatecontext['carouselimages'])) {
    $defaultImage = $OUTPUT->image_url('slide0', 'theme_nexo');
    $templatecontext['carouselimages'][] = [
        'url'         => (string)$defaultImage,
        'link'        => '',
        'title'       => get_string('default_slide_title', 'theme_nexo'),
        'first'       => true,
        'description' => '', // Puedes agregar descripción si tienes ese campo
        'button_url'  => '#',
        'index'       => 0
...
// =========================================================================
echo $OUTPUT->render_from_template('theme_nexo/core/login-custom', $templatecontext);