...
/**
 * Strings for component 'theme_nexo'
 *
 * @package   theme_nexo
...
// General strings
$string['pluginname'] = 'NEXO';
$string['configtitle'] = 'NEXO Theme';
$string['choosereadme'] = 'Nexo is a child theme created for the Instituto Superior de Educación Rural (ISER).';

// New strings for scheduled tasks
$string['license_check_task'] = 'NEXO license verification task';
...
$string['abouttext_default'] = '<p>Instituto Superior de Educación Rural (ISER)</p>';
$string['credit'] = 'Desarrollado por Alonso Arias para la Vicerrectoría Académica';
...
<p>The Nexo theme was customized for the Instituto Superior de Educación Rural (ISER).</p>
<p>It keeps the same functionality as the original theme while updating institutional branding.</p>
<p>Version: 4.5.0</p>
</div>';
