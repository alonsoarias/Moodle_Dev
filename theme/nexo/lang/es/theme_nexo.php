...
$string['configtitle'] = 'Tema NEXO';
$string['choosereadme'] = 'Nexo es un tema hijo de RemUI creado para el Instituto Superior de Educación Rural (ISER).';

// Nuevas cadenas para tareas programadas
$string['license_check_task'] = 'Tarea de verificación de licencia para NEXO';
...
$string['themeinfotext'] = 'Este tema fue personalizado para la Vicerrectoría Académica del Instituto Superior de Educación Rural (ISER).';
