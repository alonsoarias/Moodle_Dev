 ...
 */
function theme_nexo_license_autoload() {
    global $CFG;
    ...
    if (!file_exists($CFG->dirroot . '/theme/nexo/classes/controller/LicenseController.php') || 
        !file_exists($CFG->dirroot . '/theme/nexo/classes/controller/RemUIController.php')) {
        return;
    }
    
    // Cargar nuestras clases primero
    require_once($CFG->dirroot . '/theme/nexo/classes/controller/LicenseController.php');
    require_once($CFG->dirroot . '/theme/nexo/classes/controller/RemUIController.php');
    ...
    if (!defined("PLUGINSHORTNAME")) {
        ...
        define('STOREURL', '/theme/nexo/fakecheckurl.php');
        // Nombre del autor.
