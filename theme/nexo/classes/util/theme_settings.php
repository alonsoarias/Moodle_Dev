...
class settings {
    ...
    public function __construct() {
        $this->theme = theme_config::load('nexo');
    }
    ...
    public function footer() {
        ...
        $templatecontext['my_credit'] = get_string('credit', 'theme_nexo');
        ...
        $templatecontext['abouttitle'] = $this->theme->settings->ib_abouttitle
            ...
            : get_string('abouttitle_default', 'theme_nexo'); 
        ...
        $templatecontext['abouttext'] = $this->theme->settings->ib_abouttext
            ...
            : get_string('abouttext_default', 'theme_nexo');
    ...
    public function personal_area_header() {
        ...
        if (!empty($personalareaheader)) {
            ...
            $templatecontext['headerimage'] = [
                'url' => '',
                'title' => get_string('defaultheader', 'theme_nexo')
            ];
        }
