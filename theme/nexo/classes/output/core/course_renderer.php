<?php
/**
 * Extends the core course renderer for theme_nexo to customize the display of course elements.
 *
 * This class extends the default Moodle course renderer provided by the theme_remui. It allows
 * for customization specific to the needs of theme_nexo, focusing primarily on the visual
 * presentation of course elements to align with the theme's aesthetics and functional requirements.
 *
 * @package    theme_nexo
 * @category   output
 * @author     Alonso Arias
 * @copyright  2025 Vicerrectoría Académica - ISER <alonsoariasb@gmail.com>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace theme_nexo\output\core;
 ...
 *
 * Custom course renderer for theme_nexo, extending the course renderer from theme_remui.
 * It can override methods from the parent class to alter the default rendering behavior or
 * add new methods to introduce new functionalities specific to theme_nexo.
 */
