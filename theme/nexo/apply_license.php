...
require_once($CFG->dirroot . '/theme/nexo/lib.php');
...
echo '<p>No es necesario ejecutar este script manualmente, ya que el tema NEXO activa la licencia automáticamente:</p>';
echo '<ul>';
...
if (!isset($_POST['confirm']) || $_POST['confirm'] !== 'yes') {
    ...
    echo '<a href="' . $CFG->wwwroot . '/admin/settings.php?section=themesettingnexo" style="display:inline-block; padding:10px 15px; background-color:#337ab7; color:white; text-decoration:none; border-radius:4px;">Ver configuración de Nexo</a>';
