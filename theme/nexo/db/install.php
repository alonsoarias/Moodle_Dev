 ...
 */
function xmldb_theme_nexo_install() {
    global $CFG, $DB;
    ...
    if (defined('EDD_LICENSE_STATUS')) {
        ...
        mtrace('Theme NEXO: Licencia activada automáticamente');
    } else {
        mtrace('Theme NEXO: No se pudo activar la licencia automáticamente - constantes no definidas');
    }
