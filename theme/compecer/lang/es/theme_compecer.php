...
$string['courseprogresssummary'] = 'Avance del curso: {$a->percent}% ({$a->completed}/{$a->total} actividades completadas)';
...
$string['sectionprogresssummary'] = 'Avance de la sección: {$a->percent}% ({$a->completed}/{$a->total})';
