...
$string['courseprogresssummary'] = '{$a->completed}/{$a->total} · {$a->percent}%';
...
$string['sectionprogresssummary'] = '{$a->completed}/{$a->total} · {$a->percent}%';
...
$string['progressfraction'] = '{$a->completed} de {$a->total} actividades completadas';
