...
function xmldb_enrol_nexuspay_upgrade($oldversion) {
    ...
    if ($oldversion < 2025021605) {
        $table = new xmldb_table('enrol_nexuspay');
        ...
        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2025021605, 'enrol', 'nexuspay');
    }

    if ($oldversion < 2025032601) {
        $table = new xmldb_table('enrol_nexuspay_ext');
        ...
        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2025032601, 'enrol', 'nexuspay');
    }
    ...
    if ($oldversion < 2025032604) {
        ...
        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2025032604, 'enrol', 'nexuspay');
    }
    ...
    if ($oldversion < 2025032801) {
        ...
        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2025032801, 'enrol', 'nexuspay');
    }
