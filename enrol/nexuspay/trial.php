...
$url = \enrol_nexuspay\payment\service_provider::get_success_url('nexuspay', $instanceid);
...
if ($DB->record_exists('enrol_nexuspay', ['courseid' => $instance->courseid, 'userid' => $userid])) {
    redirect($url);
}
