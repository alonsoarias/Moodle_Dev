...
// Check if we have the site configuration capability.
if ($hassiteconfig) {
    // Create a new settings page.
    $settings = new admin_settingpage(
        'format_nexusformat_settings',
        new lang_string('pluginname', 'format_nexusformat')
    );
    ...
    // Add the settings page to the course formats category.
