...
/**
 * Renderable representing the rule management list.
 *
...
/**
 * Provides data for the rule management mustache template.
 */
class rule_table implements renderable, templatable {
    /** @var array */
