...
/**
 * Quick access handler for educambot - processes quick access commands (v3.0.3).
 *
...
class quick_access_handler {
    ...
    private function get_menu_response() {
        return get_string('menu_help', 'local_educambot');
    }
    ...
    private function get_admin_users_response() {
        ...
        $response .= get_string('uploadusers', 'local_educambot') . ' ↗</a>';
    ...
    private function get_admin_courses_response() {
        ...
        $response .= '<a href="' . $addurl . '" target="_blank" rel="noopener">';
        $response .= get_string('addnewcourse', 'local_educambot') . ' ↗</a>';
    ...
    private function get_admin_reports_response() {
        ...
        $response .= get_string('viewstatistics', 'local_educambot') . ' ↗</a>';
    ...
    private function get_admin_settings_response() {
        ...
        $response .= get_string('appearancesettings', 'local_educambot') . ' ↗</a>';
    ...
    private function get_admin_plugins_response() {
        ...
        $response .= get_string('installplugins', 'local_educambot') . ' ↗</a>';
    ...
    private function get_admin_backup_response() {
        ...
        $response .= get_string('restoresite', 'local_educambot') . ' ↗</a>';
