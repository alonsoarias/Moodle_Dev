...
$string['manageknowledge'] = 'Structured knowledge';
$string['addentry'] = 'Add entry';
$string['editentry'] = 'Edit entry';
$string['deleteentry'] = 'Delete entry';
$string['addknowledge'] = 'Add knowledge entry';
$string['editknowledge'] = 'Edit knowledge entry';
...
$string['searchknowledge'] = 'Search knowledge';
$string['searchknowledgeplaceholder'] = 'Search titles, summaries or tags';
...
$string['filterstatus'] = 'Status filter';
$string['filtersuggested'] = 'Suggested filter';
$string['filtersuggestedall'] = 'All';
$string['filtersuggestedonly'] = 'Only suggested';
$string['filtersuggestednone'] = 'Not suggested';
$string['filterstatusall'] = 'All statuses';
$string['filterstatusenabled'] = 'Only enabled';
$string['filterstatusdisabled'] = 'Only disabled';
$string['filtertopic'] = 'Topic filter';
$string['filtertopicall'] = 'All topics';
$string['applyfilters'] = 'Apply filters';
$string['perpage'] = 'Per page';
$string['searchresultsfound'] = '{$a} result(s) found';
...
$string['historylimit'] = 'Conversation memory length';
$string['historylimit_desc'] = 'Maximum number of recent exchanges kept in memory to resolve follow-up questions.';
...
$string['knowledgekeywords'] = 'Use comma separated keywords to help identify the topic.';
$string['savechanges'] = 'Save changes';
$string['cancel'] = 'Cancel';
$string['noentries'] = 'No entries configured yet. Add your first rule to start helping users!';
$string['noknowledgeentries'] = 'No knowledge entries found. Create one to start the library.';
