...
$string['manageknowledge'] = 'Conocimiento estructurado';
$string['addentry'] = 'Añadir entrada';
$string['editentry'] = 'Editar entrada';
$string['deleteentry'] = 'Eliminar entrada';
$string['addknowledge'] = 'Añadir artículo';
$string['editknowledge'] = 'Editar artículo';
...
$string['searchknowledge'] = 'Buscar conocimiento';
$string['searchknowledgeplaceholder'] = 'Busca títulos, resúmenes o etiquetas';
...
$string['filtersuggested'] = 'Filtro de sugerencias';
$string['filtersuggestedall'] = 'Todos';
$string['filtersuggestedonly'] = 'Solo sugeridos';
$string['filtersuggestednone'] = 'No sugeridos';
$string['filterstatusall'] = 'Todos los estados';
$string['filterstatusenabled'] = 'Solo habilitados';
$string['filterstatusdisabled'] = 'Solo deshabilitados';
$string['filtertopic'] = 'Filtro por tema';
$string['filtertopicall'] = 'Todos los temas';
$string['applyfilters'] = 'Aplicar filtros';
$string['perpage'] = 'Por página';
$string['searchresultsfound'] = '{$a} resultado(s) encontrados';
...
$string['historylimit'] = 'Memoria de conversación (interacciones)';
$string['historylimit_desc'] = 'Número máximo de mensajes recientes que el bot recordará para resolver consultas de seguimiento.';
...
$string['knowledgekeywords'] = 'Utiliza palabras clave separadas por comas para identificar el tema.';
$string['savechanges'] = 'Guardar cambios';
$string['cancel'] = 'Cancelar';
$string['noentries'] = 'Todavía no hay entradas configuradas. ¡Añade tu primera regla para comenzar a ayudar!';
$string['noknowledgeentries'] = 'No hay artículos registrados. Crea uno para iniciar la biblioteca.';
$string['notopics'] = 'Sin temas';
