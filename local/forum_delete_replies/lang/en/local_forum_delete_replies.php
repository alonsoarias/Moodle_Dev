...
$string['admindescription'] = 'This tool allows you to delete all forum replies, keeping only the initial post of each discussion.';
$string['deletefromcourse'] = 'Delete replies from a course';
$string['deletefromcoursedesc'] = 'Select a course and delete all replies from all its forums with a single click.';
$string['nocourses'] = 'No courses available.';
$string['sitewidedeletedesc'] = 'Delete all replies from all forums across the entire site. Use with caution.';
$string['selectcourse'] = 'Please select a course.';
$string['confirmdeletecoursemsg'] = 'Are you sure you want to delete all replies from this course? This action cannot be undone.';
$string['errordetails'] = 'Error details';
$string['andmore'] = '... and {$a} more replies';
$string['deletefast'] = 'Fast delete (SQL)';
$string['deletefasttitle'] = 'Use direct SQL deletion for better performance on large forums. Bypasses some Moodle events.';
$string['progress_deleting_read'] = 'Deleting read tracking records...';
$string['progress_deleting_queue'] = 'Deleting queue records...';
$string['progress_deleting_ratings'] = 'Deleting ratings...';
$string['progress_deleting_files'] = 'Deleting attached files...';
$string['progress_deleting_posts'] = 'Deleting posts...';
$string['progress_deleting_posts_long'] = 'Deleting all reply posts (this may take a while)...';
$string['progress_preparing'] = 'Preparing deletion...';
$string['progress_updating_discussions'] = 'Updating discussion metadata...';
