...
$string['admindescription'] = 'Esta herramienta permite eliminar todas las respuestas de los foros, conservando unicamente el post inicial de cada discusion.';
$string['deletefromcourse'] = 'Eliminar respuestas de un curso';
$string['deletefromcoursedesc'] = 'Seleccione un curso y elimine todas las respuestas de todos sus foros con un solo clic.';
$string['nocourses'] = 'No hay cursos disponibles.';
$string['sitewidedeletedesc'] = 'Elimine todas las respuestas de todos los foros de todo el sitio. Use con precaucion.';
$string['selectcourse'] = 'Por favor seleccione un curso.';
$string['confirmdeletecoursemsg'] = 'Esta seguro de que desea eliminar todas las respuestas de este curso? Esta accion no se puede deshacer.';
$string['errordetails'] = 'Detalles del error';
$string['andmore'] = '... y {$a} respuestas mas';
$string['deletefast'] = 'Eliminacion rapida (SQL)';
$string['deletefasttitle'] = 'Usar eliminacion SQL directa para mejor rendimiento en foros grandes. Omite algunos eventos de Moodle.';
$string['progress_deleting_read'] = 'Eliminando registros de lectura...';
$string['progress_deleting_queue'] = 'Eliminando registros de cola...';
$string['progress_deleting_ratings'] = 'Eliminando valoraciones...';
$string['progress_deleting_files'] = 'Eliminando archivos adjuntos...';
$string['progress_deleting_posts'] = 'Eliminando posts...';
$string['progress_deleting_posts_long'] = 'Eliminando todos los posts de respuesta (esto puede tardar)...';
$string['progress_preparing'] = 'Preparando eliminacion...';
$string['progress_updating_discussions'] = 'Actualizando metadatos de discusiones...';
