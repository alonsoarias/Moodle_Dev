...
$string['recaptcha_heading_desc'] = 'Configura Google reCAPTCHA v3 para proteger tu página de login contra bots';
...
$string['recaptchaerror'] = 'La verificación de reCAPTCHA falló. Por favor, inténtelo de nuevo.';
