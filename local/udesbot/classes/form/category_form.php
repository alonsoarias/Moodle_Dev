...
class category_form extends \moodleform {
    ...
    protected function definition() {
        ...
        // Category name.
        $mform->addElement('text', 'name', get_string('categoryname', 'local_udesbot'), ['size' => 50, 'maxlength' => 100]);
        $mform->setType('name', PARAM_TEXT);
        $mform->addRule('name', get_string('required'), 'required', null, 'client');
        $mform->addRule('name', get_string('maximumchars', '', 100), 'maxlength', 100, 'client');

        // Description.
        $mform->addElement('textarea', 'description', get_string('categorydescription', 'local_udesbot'),
            ['rows' => 3, 'cols' => 50]);
        ...
        $mform->addElement('select', 'parent', get_string('parentcategory', 'local_udesbot'), $parentoptions);
