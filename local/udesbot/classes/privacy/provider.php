...
/**
 * Privacy provider implementation for local_udesbot (v1.9.0).
 *
...
namespace local_udesbot\privacy;
...
/**
 * Privacy Subsystem implementing provider interfaces for local_udesbot.
 *
 * This plugin stores user conversation data in the local_udesbot_log table.
 */
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        $sql = "SELECT c.id
                  FROM {context} c
                  JOIN {local_udesbot_log} l ON l.userid = :userid
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist->get_contexts() as $context) {
            ...
            writer::with_context($context)->export_data(
                [get_string('pluginname', 'local_udesbot'), get_string('chatconversations', 'local_udesbot')],
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        $DB->delete_records('local_udesbot_log');
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist->get_contexts() as $context) {
            ...
            $DB->delete_records('local_udesbot_log', ['userid' => $user->id]);
        }
    }
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        $DB->delete_records_select('local_udesbot_log', "userid $insql", $inparams);
    }
}
