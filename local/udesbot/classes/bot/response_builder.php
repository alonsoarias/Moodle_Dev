...
/**
 * Response builder for udesbot - builds dynamic responses with placeholders.
 *
...
class response_builder {
    ...
    private function get_course_name() {
        ...
        return $info ? $info['fullname'] : get_string('notavailable', 'local_udesbot');
    }
    ...
    private function get_course_shortname() {
        $info = $this->context->get_course_info();
        return $info ? $info['shortname'] : get_string('notavailable', 'local_udesbot');
    }
    ...
    private function get_teacher_name() {
        ...
        return get_string('theteacher', 'local_udesbot');
    }
    ...
    private function get_all_teachers() {
        $teachers = $this->context->get_course_teachers();
        if (empty($teachers)) {
            return get_string('noteachersassigned', 'local_udesbot');
        }
    ...
    private function get_course_startdate() {
        ...
        return get_string('notavailable', 'local_udesbot');
    }
    ...
    private function get_course_enddate() {
        ...
        return get_string('noenddate', 'local_udesbot');
    }
    ...
    private function get_current_grade() {
        ...
        return get_string('notgraded', 'local_udesbot');
    }
    ...
    private function get_next_assignment() {
        ...
        if ($assignment) {
            $date = $assignment->duedate ? userdate($assignment->duedate, '%d/%m/%Y') : get_string('noduedate', 'local_udesbot');
            return $assignment->name . ' - ' . get_string('duedate', 'local_udesbot') . ': ' . $date;
        }
        return get_string('nopendingassignments', 'local_udesbot');
    }
    ...
    private function get_next_assignment_name() {
        $assignment = $this->context->get_next_assignment();
        return $assignment ? $assignment->name : get_string('nopendingassignments', 'local_udesbot');
    }
    ...
    private function get_next_assignment_date() {
        ...
        return get_string('noduedate', 'local_udesbot');
    }
    ...
    private function get_next_quiz() {
        ...
        return get_string('nopendingquizzes', 'local_udesbot');
    }
    ...
    private function get_pending_tasks_list() {
        ...
        if (count($assignments) > 5) {
            $list .= get_string('andmore', 'local_udesbot', count($assignments) - 5);
        }
    ...
    private function get_next_event() {
        ...
        return get_string('noupcomingevents', 'local_udesbot');
    }
    ...
    private function get_week_events() {
        ...
        if (empty($events)) {
            return get_string('noeventthisweek', 'local_udesbot');
        }
