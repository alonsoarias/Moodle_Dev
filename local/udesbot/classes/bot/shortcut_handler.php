...
/**
 * Shortcut handler for udesbot - processes shortcut commands.
 *
...
class shortcut_handler {
    ...
    public function process_shortcut($question, $userrole = null) {
        ...
        $shortcuts = $DB->get_records('local_udesbot_shortcut', ['enabled' => 1], 'sortorder ASC');
    ...
    private function execute_shortcut($shortcut) {
        switch ($shortcut->actiontype) {
            ...
            case 'admin_backup':
                ...
                break;
            default:
                $response = get_string('unknownshortcut', 'local_udesbot');
        }
    ...
    private function get_teacher_grades_response() {
        ...
        $response .= get_string('importgrades', 'local_udesbot') . ' ↗</a><br>';
        ...
        $response .= get_string('exportgrades', 'local_udesbot') . ' ↗</a>';
    ...
    private function get_admin_users_response() {
        ...
        $response .= get_string('uploadusers', 'local_udesbot') . ' ↗</a><br>';

        // Link to cohorts.
        $cohortsurl = new \moodle_url('/cohort/index.php');
        $response .= '👨‍👩‍👧‍👦 <a href="' . $cohortsurl . '" target="_blank" rel="noopener">';
        $response .= get_string('managecohorts', 'local_udesbot') . ' ↗</a>';
    ...
    private function get_admin_courses_response() {
        ...
        $response .= get_string('restorecourse', 'local_udesbot') . ' ↗</a>';
    ...
    private function get_admin_reports_response() {
        ...
        $response .= get_string('activityreport', 'local_udesbot') . ' ↗</a><br>';

        // Link to statistics.
        $statsurl = new \moodle_url('/report/stats/index.php');
        $response .= '📈 <a href="' . $statsurl . '" target="_blank" rel="noopener">';
        $response .= get_string('viewstatistics', 'local_udesbot') . ' ↗</a><br>';
        ...
        $response .= get_string('configchanges', 'local_udesbot') . ' ↗</a>';
    ...
    private function get_admin_settings_response() {
        ...
        $response .= get_string('appearancesettings', 'local_udesbot') . ' ↗</a><br>';
        ...
        $response .= get_string('languagesettings', 'local_udesbot') . ' ↗</a><br>';
        ...
        $response .= get_string('notificationsettings', 'local_udesbot') . ' ↗</a>';
    ...
    private function get_admin_plugins_response() {
        ...
        $response .= get_string('installplugins', 'local_udesbot') . ' ↗</a><br>';
        ...
        $response .= get_string('manageactivities', 'local_udesbot') . ' ↗</a><br>';
        ...
        $response .= get_string('manageauthentication', 'local_udesbot') . ' ↗</a><br>';
        ...
        $response .= get_string('manageenrolments', 'local_udesbot') . ' ↗</a>';
    ...
    private function get_admin_backup_response() {
        ...
        $restoreurl = new \moodle_url('/backup/restorefile.php', ['contextid' => 1]);
        $response .= '📥 <a href="' . $restoreurl . '" target="_blank" rel="noopener">';
        $response .= get_string('restoresite', 'local_udesbot') . ' ↗</a><br>';

        // Link to import.
        $importurl = new \moodle_url('/backup/import.php');
        $response .= '📤 <a href="' . $importurl . '" target="_blank" rel="noopener">';
        $response .= get_string('importcourse', 'local_udesbot') . ' ↗</a>';
    ...
    public static function get_all_shortcuts($enabledonly = true) {
        ...
        return $DB->get_records('local_udesbot_shortcut', $params, 'sortorder ASC');
    }
    ...
    public static function get_action_types() {
        return [
            'assignments' => get_string('actiontype_assignments', 'local_udesbot'),
            'grades' => get_string('actiontype_grades', 'local_udesbot'),
            'calendar' => get_string('actiontype_calendar', 'local_udesbot'),
            'messages' => get_string('actiontype_messages', 'local_udesbot'),
            'teachers' => get_string('actiontype_teachers', 'local_udesbot'),
            'course' => get_string('actiontype_course', 'local_udesbot'),
            'progress' => get_string('actiontype_progress', 'local_udesbot'),
            'courses' => get_string('actiontype_courses', 'local_udesbot'),
            'participants' => get_string('actiontype_participants', 'local_udesbot'),
            'badges' => get_string('actiontype_badges', 'local_udesbot'),
            'teacher_grades' => get_string('actiontype_teacher_grades', 'local_udesbot'),
            'admin_users' => get_string('actiontype_admin_users', 'local_udesbot'),
            'admin_courses' => get_string('actiontype_admin_courses', 'local_udesbot'),
            'admin_reports' => get_string('actiontype_admin_reports', 'local_udesbot'),
            'admin_settings' => get_string('actiontype_admin_settings', 'local_udesbot'),
            'admin_plugins' => get_string('actiontype_admin_plugins', 'local_udesbot'),
            'admin_security' => get_string('actiontype_admin_security', 'local_udesbot'),
            'admin_backup' => get_string('actiontype_admin_backup', 'local_udesbot'),
        ];
    }
}
